    ...
    <>
      ...
      <div className="flex justify-center">      
        <p className="para ">
          ...
          <br></br>I embarked on this wild trading journey with one simple goal:
          making those sweet, sweet money! So, I decided to start with a demo
          account because who wants to lose money, right?
          <br></br>I distinctly remember my first trade not going as planned,
          and that was a bit discouraging. But instead of giving up, I persisted
          and continued taking more trades.
          ...
          like. Then, I stumbled upon 'Trading Zone' by Mark Douglas. The more I
          read it, the more I grasped that trading is primarily a mental game.
          It's not just about indicators or skill; it's about having the right
          mentality.
          <br></br>
          So, I did a 180 with my trading mindset and started watching the
          market. Instead of chasing every shiny object out there, I focused on
          my trusty companions, USDCAD and GBPJPY.
          <br></br>
